...
namespace AdvViz::SDK
{
	namespace Impl
	{
		...
		public:
			...
			Http::Response DoPut(const std::string& url, const std::string& body = "", const Headers& headers = {}) override;
			Http::Response DoPutBinaryFile(const std::string& url, const std::string& filePath, const Headers& headers = {}) override;
			Http::Response DoPatch(const std::string& url, const std::string& body = "", const Headers& headers = {}) override;
			Http::Response DoPost(const std::string& url, const std::string& body = "", const Headers& headers = {}) override;
			void DoAsyncPost(std::function<void(const Response&)> callback, const std::string& url, const std::string& body = "", const Headers& headers = {}) override;
			void DoAsyncPut(std::function<void(const Response&)> callback, const std::string& url, const std::string& body = "", const Headers& headers = {});
			...
			Http::Response DoDelete(const std::string& url, const std::string& body = "", const Headers& headers = {}) override;
