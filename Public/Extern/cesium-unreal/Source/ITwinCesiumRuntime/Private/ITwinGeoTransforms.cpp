...
ITwinGeoTransforms::ITwinGeoTransforms()
    : _coordinateSystem(
          glm::dvec3(0.0),
          LocalDirection::East,
...
void ITwinGeoTransforms::setCenter(const glm::dvec3& center) noexcept {
...
void ITwinGeoTransforms::setEllipsoid(
...
glm::dquat ITwinGeoTransforms::ComputeSurfaceNormalRotation(
...
glm::dquat ITwinGeoTransforms::ComputeSurfaceNormalRotationUnreal(
    const glm::dvec3& oldPosition,
    const glm::dvec3& newPosition) const {
...
glm::dvec3 ITwinGeoTransforms::TransformLongitudeLatitudeHeightToEcef(
...
glm::dvec3 ITwinGeoTransforms::TransformEcefToLongitudeLatitudeHeight(
...
glm::dvec3 ITwinGeoTransforms::TransformLongitudeLatitudeHeightToUnreal(
...
glm::dvec3 ITwinGeoTransforms::TransformUnrealToLongitudeLatitudeHeight(
    const glm::dvec3& origin,
...
glm::dvec3 ITwinGeoTransforms::TransformEcefToUnreal(
    const glm::dvec3& origin,
    const glm::dvec3& ecef) const noexcept {
  return this->_coordinateSystem.ecefPositionToLocal(ecef) - origin;
}

glm::dvec3 ITwinGeoTransforms::TransformUnrealToEcef(
    const glm::dvec3& origin,
    const glm::dvec3& ue) const noexcept {
  return this->_coordinateSystem.localPositionToEcef(ue + origin);
}

glm::dquat ITwinGeoTransforms::TransformRotatorUnrealToEastSouthUp(
    const glm::dvec3& origin,
...
glm::dquat ITwinGeoTransforms::TransformRotatorEastSouthUpToUnreal(
    const glm::dvec3& origin,
...
glm::dmat4 ITwinGeoTransforms::ComputeEastSouthUpToUnreal(
    const glm::dvec3& origin,
    const glm::dvec3& ue) const noexcept {
  glm::dvec3 ecef = this->TransformUnrealToEcef(origin, ue);
...
glm::dmat3
ITwinGeoTransforms::ComputeEastNorthUpToEcef(const glm::dvec3& ecef) const noexcept {
