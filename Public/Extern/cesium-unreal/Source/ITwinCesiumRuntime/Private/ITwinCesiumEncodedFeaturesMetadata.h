 ...
 * counted by this one.
 *
 * This is used by FITwinCesiumFeatureIdSetDescription to display the names of
...
struct EncodedFeatureIdSet {
  ...
  /**
   * @brief The index of this feature ID set in the FITwinCesiumPrimitiveFeatures on
   * the glTF primitive.
   */
  int32 index;
 ...
 * specified by the FITwinCesiumPrimitiveFeaturesDescription.
 */
 ...
 *
 * This is used by FITwinCesiumPropertyTableDescription to display the names of
 ...
 * corresponding class will be substituted.
 *
 * This is used by FITwinCesiumPropertyTextureDescription to display the names of
...
EncodedPrimitiveMetadata encodePrimitiveMetadataAnyThreadPart(
    ...
    const FITwinCesiumPrimitiveMetadata& primitive,
