...
BEGIN_DEFINE_SPEC(
    ...
    // UITwinCesiumSubLevelSwitcherComponent::_updateSubLevelStateEditor(), which is called by
...
TObjectPtr<UITwinCesiumSubLevelComponent> pLevelComponent1;
TObjectPtr<ALevelInstance> pSubLevel2;
TObjectPtr<UITwinCesiumSubLevelComponent> pLevelComponent2;
TObjectPtr<AITwinCesiumGeoreference> pGeoreference;
TObjectPtr<AITwinGlobeAwareDefaultPawn> pPawn;
...
void FSubLevelsSpec::Define() {
  BeforeEach([this]() {
    ...
    pLevelComponent1 =
        Cast<UITwinCesiumSubLevelComponent>(pSubLevel1->AddComponentByClass(
    ...
    pLevelComponent2 =
        Cast<UITwinCesiumSubLevelComponent>(pSubLevel2->AddComponentByClass(
            UITwinCesiumSubLevelComponent::StaticClass(),
            false,
            FTransform::Identity,
            false));
    ...
    pPawn = pWorld->SpawnActor<AITwinGlobeAwareDefaultPawn>();
  ...
  Describe("activates the closest sub-level that is in range", [this]() {
    ...
    BeforeEach(EAsyncExecution::TaskGraphMainThread, [this]() {
      ...
      UITwinCesiumSubLevelComponent* pPlayLevelComponent1 =
