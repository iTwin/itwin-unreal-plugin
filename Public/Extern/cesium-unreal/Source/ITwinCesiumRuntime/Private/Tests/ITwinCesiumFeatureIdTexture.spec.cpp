...
BEGIN_DEFINE_SPEC(
    FITwinCesiumFeatureIdTextureSpec,
...
END_DEFINE_SPEC(FITwinCesiumFeatureIdTextureSpec)

void FITwinCesiumFeatureIdTextureSpec::Define() {
  ...
  Describe("GetFeatureIDForTextureCoordinates", [this]() {
    ...
    It("returns -1 for invalid texture", [this]() {
      ...
      TestEqual(
          "FeatureID",
          UITwinCesiumFeatureIdTextureBlueprintLibrary::
    ...
    It("returns correct value for valid attribute", [this]() {
      ...
      for (size_t i = 0; i < texCoords.size(); i++) {
        ...
        int64 featureID = UITwinCesiumFeatureIdTextureBlueprintLibrary::
  ...
  Describe("GetFeatureIDForVertex", [this]() {
    ...
    It("returns -1 for invalid texture", [this]() {
      ...
      TestEqual(
          "FeatureIDForVertex",
          UITwinCesiumFeatureIdTextureBlueprintLibrary::GetFeatureIDForVertex(
              featureIDTexture,
              0),
          -1);
    });
  ...
  Describe("GetFeatureIDFromHit", [this]() {
    ...
    It("returns -1 for invalid texture", [this]() {
      ...
      TestEqual(
          "FeatureIDFromHit",
          UITwinCesiumFeatureIdTextureBlueprintLibrary::GetFeatureIDFromHit(
              featureIDTexture,
              Hit),
          -1);
    });
