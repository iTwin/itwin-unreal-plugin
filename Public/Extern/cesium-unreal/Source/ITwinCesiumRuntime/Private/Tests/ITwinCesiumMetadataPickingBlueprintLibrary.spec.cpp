...
BEGIN_DEFINE_SPEC(
    FITwinCesiumMetadataPickingSpec,
...
END_DEFINE_SPEC(FITwinCesiumMetadataPickingSpec)

void FITwinCesiumMetadataPickingSpec::Define() {
  Describe("FindUVFromHit", [this]() {
    ...
    It("returns false if hit has no valid component", [this]() {
      ...
      TestFalse(
          "found hit",
          UITwinCesiumMetadataPickingBlueprintLibrary::FindUVFromHit(Hit, 0, UV));
    });
    ...
    It("returns false if specified texcoord set does not exist", [this]() {
      ...
      TestFalse(
          "found hit",
          UITwinCesiumMetadataPickingBlueprintLibrary::FindUVFromHit(Hit, 1, UV));
    });
  ...
  Describe("GetPropertyTableValuesFromHit", [this]() {
    ...
    It("returns empty map for invalid component", [this]() {
      ...
      pModelComponent->Metadata = FITwinCesiumModelMetadata(model, *pModelMetadata);
      pPrimitiveComponent->Features =
          FITwinCesiumPrimitiveFeatures(model, *pPrimitive, *pMeshFeatures);
    ...
    It("returns empty values if feature ID set is not associated with a property table",
       [this]() {
         ...
         pModelComponent->Metadata =
             FITwinCesiumModelMetadata(model, *pModelMetadata);
         pPrimitiveComponent->Features =
             FITwinCesiumPrimitiveFeatures(model, *pPrimitive, *pMeshFeatures);
         ...
         const auto values = UITwinCesiumMetadataPickingBlueprintLibrary::
  ...
  Describe("GetPropertyTextureValuesFromHit", [this]() {
    ...
    It("returns empty map for invalid component", [this]() {
      ...
      pPrimitiveComponent->Metadata =
          FITwinCesiumPrimitiveMetadata(*pPrimitive, *pPrimitiveMetadata);

      FHitResult Hit;
      Hit.FaceIndex = -1;
      Hit.Component = nullptr;

      auto values = UITwinCesiumMetadataPickingBlueprintLibrary::
    ...
    It("returns empty map for invalid primitive property texture index",
       [this]() {
         ...
         values = UITwinCesiumMetadataPickingBlueprintLibrary::
             GetPropertyTextureValuesFromHit(Hit, 1);
         TestTrue(
             "empty values for positive out-of-range index",
             values.IsEmpty());
    ...
    It("returns empty values if property texture does not exist in model metadata",
       [this]() {
         ...
         pModelComponent->Metadata = FITwinCesiumModelMetadata();
  ...
  Describe("Deprecated", [this]() {
    ...
    Describe("GetMetadataValuesForFaceAsStrings", [this]() {
      ...
      It("returns values for first feature ID set by default", [this]() {
        ...
        for (size_t i = 0; i < scalarValues.size(); i++) {
          const auto strings = UITwinCesiumMetadataPickingBlueprintLibrary::
