...
BEGIN_DEFINE_SPEC(
    FITwinCesiumGeoreferenceSpec,
    "Cesium.Unit.Georeference",
    EAutomationTestFlags::ApplicationContextMask |
        EAutomationTestFlags::ProductFilter)

TObjectPtr<AITwinCesiumGeoreference> pGeoreferenceNullIsland;
TObjectPtr<AITwinCesiumGeoreference> pGeoreference90Longitude;

END_DEFINE_SPEC(FITwinCesiumGeoreferenceSpec)
...
void FITwinCesiumGeoreferenceSpec::Define() {
  BeforeEach([this]() {
    ...
    pGeoreferenceNullIsland->SetOriginLongitudeLatitudeHeight(
        FVector(0.0, 0.0, 0.0));
    pGeoreference90Longitude = pWorld->SpawnActor<AITwinCesiumGeoreference>();
