...
UITwinCesiumSubLevelSwitcherComponent::UITwinCesiumSubLevelSwitcherComponent() {
  this->PrimaryComponentTick.bCanEverTick = true;
}

void UITwinCesiumSubLevelSwitcherComponent::RegisterSubLevel(
...
void UITwinCesiumSubLevelSwitcherComponent::UnregisterSubLevel(
    ALevelInstance* pSubLevel) noexcept {
...
UITwinCesiumSubLevelSwitcherComponent::GetRegisteredSubLevels() const noexcept {
...
ALevelInstance*
UITwinCesiumSubLevelSwitcherComponent::GetCurrentSubLevel() const noexcept {
  return this->_pCurrent.Get();
}

ALevelInstance*
UITwinCesiumSubLevelSwitcherComponent::GetTargetSubLevel() const noexcept {
  return this->_pTarget.Get();
}

void UITwinCesiumSubLevelSwitcherComponent::SetTargetSubLevel(
...
void UITwinCesiumSubLevelSwitcherComponent::TickComponent(
    float DeltaTime,
...
void UITwinCesiumSubLevelSwitcherComponent::_updateSubLevelStateGame() {
  ...
  if (this->_pCurrent == nullptr && this->_pTarget != nullptr) {
    ...
    UITwinCesiumSubLevelComponent* pTargetComponent =
        this->_pTarget->FindComponentByClass<UITwinCesiumSubLevelComponent>();
    if (pTargetComponent)
...
void UITwinCesiumSubLevelSwitcherComponent::_updateSubLevelStateEditor() {
  ...
  if (this->_pTarget != nullptr) {
    UITwinCesiumSubLevelComponent* pTargetComponent =
        this->_pTarget.Get()->FindComponentByClass<UITwinCesiumSubLevelComponent>();
    if (pTargetComponent)
      pTargetComponent->UpdateGeoreferenceIfSubLevelIsActive();
...
ULevelStreaming*
UITwinCesiumSubLevelSwitcherComponent::_getLevelStreamingForSubLevel(
