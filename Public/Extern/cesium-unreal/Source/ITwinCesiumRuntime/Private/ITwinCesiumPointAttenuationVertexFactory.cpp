...
void FITwinCesiumPointAttenuationIndexBuffer::InitRHI(
...
void FITwinCesiumPointAttenuationIndexBuffer::InitRHI() {
  ...
  FRHIResourceCreateInfo CreateInfo(TEXT("FITwinCesiumPointAttenuationIndexBuffer"));
...
class FITwinCesiumPointAttenuationVertexFactoryShaderParameters
    : public FVertexFactoryShaderParameters {

  DECLARE_TYPE_LAYOUT(
      FITwinCesiumPointAttenuationVertexFactoryShaderParameters,
      NonVirtual);
...
public:
  ...
  void GetElementShaderBindings(
    ...
    FITwinCesiumPointAttenuationBatchElementUserData* UserData =
        (FITwinCesiumPointAttenuationBatchElementUserData*)BatchElement.UserData;
 ...
 * layouts.
 */
class FITwinCesiumPointAttenuationDummyVertexBuffer : public FVertexBuffer {
public:
#if ENGINE_VERSION_5_3_OR_HIGHER
...
#if ENGINE_VERSION_5_3_OR_HIGHER
void FITwinCesiumPointAttenuationDummyVertexBuffer::InitRHI(
    FRHICommandListBase& RHICmdList) {
#else
void FITwinCesiumPointAttenuationDummyVertexBuffer::InitRHI() {
#endif
  FRHIResourceCreateInfo CreateInfo(
      TEXT("FITwinCesiumPointAttenuationDummyVertexBuffer"));
...
TGlobalResource<FITwinCesiumPointAttenuationDummyVertexBuffer>
    GCesiumPointAttenuationDummyVertexBuffer;

FITwinCesiumPointAttenuationVertexFactory::FITwinCesiumPointAttenuationVertexFactory(
...
bool FITwinCesiumPointAttenuationVertexFactory::ShouldCompilePermutation(
...
#if ENGINE_VERSION_5_3_OR_HIGHER
void FITwinCesiumPointAttenuationVertexFactory::InitRHI(
    FRHICommandListBase& RHICmdList) {
#else
void FITwinCesiumPointAttenuationVertexFactory::InitRHI() {
#endif
...
void FITwinCesiumPointAttenuationVertexFactory::ReleaseRHI() {
  FVertexFactory::ReleaseRHI();
}

IMPLEMENT_TYPE_LAYOUT(FITwinCesiumPointAttenuationVertexFactoryShaderParameters);
