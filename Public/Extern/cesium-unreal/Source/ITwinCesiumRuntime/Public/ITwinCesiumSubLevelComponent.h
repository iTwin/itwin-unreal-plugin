...
#include "ITwinCesiumSubLevelComponent.generated.h"
...
class ITWINCESIUMRUNTIME_API UITwinCesiumSubLevelComponent : public UActorComponent {
  GENERATED_BODY()
...
private:
   ...
   */
  UITwinCesiumSubLevelSwitcherComponent* _getSwitcher() noexcept;
