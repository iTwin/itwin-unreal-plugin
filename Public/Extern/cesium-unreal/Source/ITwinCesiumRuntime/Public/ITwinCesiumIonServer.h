...
#include "ITwinCesiumIonServer.generated.h"
 ...
 */
UCLASS()
class ITWINCESIUMRUNTIME_API UITwinCesiumIonServer : public UDataAsset {
  GENERATED_BODY()
...
public:
   ...
   * does not exist.
   */
  static UITwinCesiumIonServer* GetDefaultServer();
   ...
   */
  static UITwinCesiumIonServer* GetServerForNewObjects();
   ...
   */
  static void SetServerForNewObjects(UITwinCesiumIonServer* Server);
   ...
   */
  static UITwinCesiumIonServer* GetBackwardCompatibleServer(const FString& apiUrl);
#endif
...
private:
  static UITwinCesiumIonServer* _pDefaultForNewObjects;
};
