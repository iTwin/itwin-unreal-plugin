...
#include "ITwinCustomDepthParameters.generated.h"

USTRUCT(BlueprintType)
struct ITWINCESIUMRUNTIME_API FITwinCustomDepthParameters {
...
public:
  ...
  bool operator==(const FITwinCustomDepthParameters& other) const {
