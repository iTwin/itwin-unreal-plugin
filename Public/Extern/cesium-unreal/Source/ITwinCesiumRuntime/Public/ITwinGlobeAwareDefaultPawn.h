...
#include <vector>
#include "ITwinGlobeAwareDefaultPawn.generated.h"

class AITwinCesiumGeoreference;
class UITwinCesiumGlobeAnchorComponent;
class UCurveFloat;
class UITwinCesiumFlyToComponent;
 ...
 */
UCLASS()
class ITWINCESIUMRUNTIME_API AITwinGlobeAwareDefaultPawn : public ADefaultPawn {
  GENERATED_BODY()

public:
  AITwinGlobeAwareDefaultPawn();
...
protected:
  ...
  UPROPERTY(
      ...
      Meta =
          (DeprecatedProperty,
           DeprecationMessage =
               "Get the Georeference instance from the Globe Anchor Component instead."))
  AITwinCesiumGeoreference* Georeference_DEPRECATED;
  ...
  AITwinCesiumGeoreference* GetGeoreference() const;
