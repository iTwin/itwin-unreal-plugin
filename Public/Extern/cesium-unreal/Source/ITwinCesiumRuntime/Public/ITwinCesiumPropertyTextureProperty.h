...
#include <any>
#include "ITwinCesiumPropertyTextureProperty.generated.h"

/**
 * @brief Reports the status of a FITwinCesiumPropertyTextureProperty. If the
...
struct ITWINCESIUMRUNTIME_API FITwinCesiumPropertyTextureProperty {
...
private:
  ...
  friend class UITwinCesiumPropertyTexturePropertyBlueprintLibrary;
};

UCLASS()
class ITWINCESIUMRUNTIME_API UITwinCesiumPropertyTexturePropertyBlueprintLibrary
...
public:
  ...
  GetValueType(UPARAM(ref) const FITwinCesiumPropertyTextureProperty& Property);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|PropertyTextureProperty")
  static TArray<int64>
  GetChannels(UPARAM(ref) const FITwinCesiumPropertyTextureProperty& Property);
  ...
  GetOffset(UPARAM(ref) const FITwinCesiumPropertyTextureProperty& Property);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|PropertyTextureProperty")
  static FITwinCesiumMetadataValue
  GetScale(UPARAM(ref) const FITwinCesiumPropertyTextureProperty& Property);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|PropertyTextureProperty")
  static FITwinCesiumMetadataValue
  GetMinimumValue(UPARAM(ref) const FITwinCesiumPropertyTextureProperty& Property);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|PropertyTextureProperty")
  static FITwinCesiumMetadataValue
  GetMaximumValue(UPARAM(ref) const FITwinCesiumPropertyTextureProperty& Property);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|PropertyTextureProperty")
  static FITwinCesiumMetadataValue
  GetNoDataValue(UPARAM(ref) const FITwinCesiumPropertyTextureProperty& Property);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|PropertyTextureProperty")
  static FITwinCesiumMetadataValue
  GetDefaultValue(UPARAM(ref) const FITwinCesiumPropertyTextureProperty& Property);
  ...
  static int64
  GetComponentCount(UPARAM(ref) const FITwinCesiumPropertyTextureProperty& Property);
