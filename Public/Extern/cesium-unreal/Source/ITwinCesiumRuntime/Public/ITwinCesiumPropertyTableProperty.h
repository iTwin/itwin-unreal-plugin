...
#include <string_view>
#include <variant>
#include "ITwinCesiumPropertyTableProperty.generated.h"

/**
 * @brief Reports the status of a FITwinCesiumPropertyTableProperty. If the property
...
struct ITWINCESIUMRUNTIME_API FITwinCesiumPropertyTableProperty {
...
private:
  ...
  friend class UITwinCesiumPropertyTablePropertyBlueprintLibrary;
};

UCLASS()
class ITWINCESIUMRUNTIME_API UITwinCesiumPropertyTablePropertyBlueprintLibrary
...
public:
  ...
  GetValueType(UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|PropertyTableProperty")
  static int64
  GetPropertySize(UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property);
  ...
  static int64
  GetNumberOfFeatures(UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property);
  PRAGMA_ENABLE_DEPRECATION_WARNINGS
  ...
  static int64
  GetComponentCount(UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property);
  PRAGMA_ENABLE_DEPRECATION_WARNINGS
   ...
   * FITwinCesiumPropertyArray. If the property is not an array type, this returns an
   * empty array.
   *
   ...
   *
   * @param featureID The ID of the feature.
   * @return The property value as a FITwinCesiumPropertyArray.
   */
  UFUNCTION(
      BlueprintCallable,
      BlueprintPure,
      Category = "Cesium|Metadata|PropertyTableProperty")
  static FITwinCesiumPropertyArray GetArray(
      UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property,
      int64 FeatureID);
  ...
  UFUNCTION(
      ...
      BlueprintPure,
      Category = "Cesium|Metadata|PropertyTableProperty")
  static FITwinCesiumMetadataValue GetValue(
      UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property,
      int64 FeatureID);
  ...
  static FITwinCesiumMetadataValue GetGenericValue(
      UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property,
      int64 FeatureID);
  PRAGMA_ENABLE_DEPRECATION_WARNINGS
  ...
  UFUNCTION(
      ...
      BlueprintPure,
      Category = "Cesium|Metadata|PropertyTableProperty")
  static FITwinCesiumMetadataValue GetRawValue(
      UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property,
      int64 FeatureID);
  ...
  UFUNCTION(
      ...
      BlueprintPure,
      Category = "Cesium|Metadata|PropertyTableProperty")
  static FITwinCesiumMetadataValue
  GetOffset(UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|PropertyTableProperty")
  static FITwinCesiumMetadataValue
  GetScale(UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|PropertyTableProperty")
  static FITwinCesiumMetadataValue
  GetMinimumValue(UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|PropertyTableProperty")
  static FITwinCesiumMetadataValue
  GetMaximumValue(UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|PropertyTableProperty")
  static FITwinCesiumMetadataValue
  GetNoDataValue(UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property);
  ...
  UFUNCTION(
      ...
      Category = "Cesium|Metadata|PropertyTableProperty")
  static FITwinCesiumMetadataValue
  GetDefaultValue(UPARAM(ref) const FITwinCesiumPropertyTableProperty& Property);
};
