...
#include "ITwinCesiumCamera.generated.h"
...
struct ITWINCESIUMRUNTIME_API FITwinCesiumCamera {
...
public:
  ...
  /**
   * @brief Construct an uninitialized FITwinCesiumCamera object.
   */
  FITwinCesiumCamera();

  /**
   * @brief Construct a new FITwinCesiumCamera object.
   *
