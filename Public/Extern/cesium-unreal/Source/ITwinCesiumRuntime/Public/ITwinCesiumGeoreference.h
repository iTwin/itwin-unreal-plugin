...
#include "ITwinCesiumSubLevel.h"
#include "GameFramework/Actor.h"
#include "ITwinGeoTransforms.h"
#include "ITwinOriginPlacement.h"
#include "ITwinCesiumGeoreference.generated.h"

class APlayerCameraManager;
class FLevelCollectionModel;
class UITwinCesiumSubLevelSwitcherComponent;
 ...
 */
UCLASS()
class ITWINCESIUMRUNTIME_API AITwinCesiumGeoreference : public AActor {
  GENERATED_BODY()
public:
  /**
  ...
  static AITwinCesiumGeoreference* GetDefaultGeoreferenceForActor(AActor* Actor);
...
private:
  ...
  UPROPERTY(
      ...
      meta = (AllowPrivateAccess))
  UITwinCesiumSubLevelSwitcherComponent* SubLevelSwitcher;
...
public:
   ...
   */
  UFUNCTION(BlueprintGetter)
  UITwinCesiumSubLevelSwitcherComponent* GetSubLevelSwitcher() const {
...
public:
  UE_DEPRECATED(
      "Cesium For Unreal v2.0",
      "Use transformation functions on AITwinCesiumGeoreference and UITwinCesiumWgs84Ellipsoid instead.")
  ITwinGeoTransforms GetGeoTransforms() const noexcept;
...
private:
  ...
  UPROPERTY(
      Meta =
          (DeprecatedProperty,
           DeprecationMessage =
               "Create sub-levels by adding a UITwinCesiumSubLevelComponent to an ALevelInstance Actor."))
  TArray<FITwinCesiumSubLevel> CesiumSubLevels_DEPRECATED;
...
private:
  ...
  friend class FITwinCesiumGeoreferenceCustomization;
#pragma endregion
};
