...
#include "ITwinCesiumIonRasterOverlay.generated.h"

class UITwinCesiumIonServer;
...
class ITWINCESIUMRUNTIME_API UITwinCesiumIonRasterOverlay : public UITwinCesiumRasterOverlay {
  GENERATED_BODY()
