...
#include "ITwinCesiumMetadataValueType.generated.h"
 ...
 * deprecated; use FITwinCesiumMetadataValueType to get the complete type information
...
struct ITWINCESIUMRUNTIME_API FITwinCesiumMetadataValueType {
  ...
  inline bool operator==(const FITwinCesiumMetadataValueType& ValueType) const {
