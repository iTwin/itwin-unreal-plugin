...
#include "ITwinCesiumGlobeAnchorComponent.generated.h"
...
class ITWINCESIUMRUNTIME_API UITwinCesiumGlobeAnchorComponent : public UActorComponent {
  GENERATED_BODY()
...
private:
  ...
  TSoftObjectPtr<AITwinCesiumGeoreference> Georeference = nullptr;
...
public:
   ...
   */
  UFUNCTION(BlueprintGetter)
  AITwinCesiumGeoreference* GetResolvedGeoreference() const;
  ...
  AITwinCesiumGeoreference* ResolveGeoreference(bool bForceReresolve = false);
...
private:
  ...
  friend class FITwinCesiumGlobeAnchorCustomization;
#pragma endregion
};
