...
#include "ITwinCesiumPointCloudShading.generated.h"

/**
 * Options for adjusting how point clouds are rendered using 3D Tiles.
 */
USTRUCT(BlueprintType)
struct ITWINCESIUMRUNTIME_API FITwinCesiumPointCloudShading {
  ...
  bool
  operator==(const FITwinCesiumPointCloudShading& OtherPointCloudShading) const {
