...
#include "ITwinCesiumRasterOverlayLoadFailureDetails.h"
...
#include <memory>
#include "ITwinCesiumRasterOverlay.generated.h"
...
DECLARE_MULTICAST_DELEGATE_OneParam(
    FITwinCesiumRasterOverlayLoadFailure,
    const FITwinCesiumRasterOverlayLoadFailureDetails&);

ITWINCESIUMRUNTIME_API extern FITwinCesiumRasterOverlayLoadFailure
 ...
 */
UCLASS(Abstract)
class ITWINCESIUMRUNTIME_API UITwinCesiumRasterOverlay : public UActorComponent {
  GENERATED_BODY()
...
protected:
  ...
  CreateOverlay(const CesiumRasterOverlays::RasterOverlayOptions& options = {})
      PURE_VIRTUAL(UITwinCesiumRasterOverlay::CreateOverlay, return nullptr;);
