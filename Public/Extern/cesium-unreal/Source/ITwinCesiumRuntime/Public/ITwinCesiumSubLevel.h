...
#include "ITwinCesiumSubLevel.generated.h"

class ULevelStreaming;

struct UE_DEPRECATED(
    5.0,
    "The FITwinCesiumSubLevel struct has been deprecated. Use Level Instance Actors and UITwinCesiumSubLevelComponent instead.")
    FITwinCesiumSubLevel;

/*
 * Sublevels can be georeferenced to the globe by filling out this struct.
 */
USTRUCT()
struct FITwinCesiumSubLevel {
  GENERATED_BODY()
