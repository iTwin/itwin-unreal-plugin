...
#include "ITwinCesiumFeaturesMetadataComponent.generated.h"
 ...
 */
USTRUCT()
struct ITWINCESIUMRUNTIME_API FITwinCesiumFeatureIdSetDescription {
 ...
 */
USTRUCT()
struct ITWINCESIUMRUNTIME_API FITwinCesiumPrimitiveFeaturesDescription {
  GENERATED_USTRUCT_BODY()
  ...
  TArray<FITwinCesiumFeatureIdSetDescription> FeatureIdSets;
};
#pragma endregion
 ...
 */
USTRUCT()
struct ITWINCESIUMRUNTIME_API FITwinCesiumPropertyTablePropertyDescription {
  GENERATED_USTRUCT_BODY()
   ...
   */
  UPROPERTY(EditAnywhere, Category = "Cesium")
  FITwinCesiumMetadataEncodingDetails EncodingDetails;
};
 ...
 */
USTRUCT()
struct ITWINCESIUMRUNTIME_API FITwinCesiumPropertyTableDescription {
  GENERATED_USTRUCT_BODY()
  ...
  TArray<FITwinCesiumPropertyTablePropertyDescription> Properties;
};
 ...
 */
USTRUCT()
struct ITWINCESIUMRUNTIME_API FITwinCesiumPropertyTexturePropertyDescription {
  GENERATED_USTRUCT_BODY()
 ...
 */
USTRUCT()
struct ITWINCESIUMRUNTIME_API FITwinCesiumPropertyTextureDescription {
  GENERATED_USTRUCT_BODY()
   ...
   */
  UPROPERTY(EditAnywhere, Category = "Cesium", Meta = (TitleProperty = "Name"))
  TArray<FITwinCesiumPropertyTexturePropertyDescription> Properties;
};
 ...
 */
USTRUCT()
struct ITWINCESIUMRUNTIME_API FITwinCesiumPrimitiveMetadataDescription {
  GENERATED_USTRUCT_BODY()
 ...
 */
USTRUCT()
struct ITWINCESIUMRUNTIME_API FITwinCesiumModelMetadataDescription {
  GENERATED_USTRUCT_BODY()
  ...
  UPROPERTY(
      ...
      Category = "Metadata",
      Meta = (TitleProperty = "Name"))
  TArray<FITwinCesiumPropertyTableDescription> PropertyTables;
  ...
  UPROPERTY(
      ...
      Category = "Metadata",
      Meta = (TitleProperty = "Name"))
  TArray<FITwinCesiumPropertyTextureDescription> PropertyTextures;
};
 ...
 */
USTRUCT()
struct ITWINCESIUMRUNTIME_API FITwinCesiumFeaturesMetadataDescription {
  GENERATED_USTRUCT_BODY()
...
public:
   ...
   * EXT_mesh_features on a glTF's primitives.
   */
  FITwinCesiumPrimitiveFeaturesDescription Features;

  /**
   * @brief Description of the metadata used by the EXT_structural_metadata on a
   * glTF's primitives.
   */
  FITwinCesiumPrimitiveMetadataDescription PrimitiveMetadata;

  /**
   * @brief Description of metadata from a glTF's EXT_structural_metadata
   * extension.
   */
  FITwinCesiumModelMetadataDescription ModelMetadata;
};
...
class ITWINCESIUMRUNTIME_API UITwinCesiumFeaturesMetadataComponent
...
public:
  ...
  // Using the FITwinCesiumPrimitiveFeaturesDescription and
  // FITwinCesiumModelMetadataDescription structs makes the UI less readable, so the
