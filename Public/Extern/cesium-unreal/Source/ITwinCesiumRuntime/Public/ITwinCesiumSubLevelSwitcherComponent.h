...
#include "ITwinCesiumSubLevelSwitcherComponent.generated.h"
...
class ITWINCESIUMRUNTIME_API UITwinCesiumSubLevelSwitcherComponent
...
private:
  ...
  // below.
  friend class UITwinCesiumSubLevelComponent;
