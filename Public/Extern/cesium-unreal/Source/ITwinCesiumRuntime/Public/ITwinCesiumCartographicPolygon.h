...
#include "ITwinCesiumCartographicPolygon.generated.h"
...
class ITWINCESIUMRUNTIME_API AITwinCesiumCartographicPolygon : public AActor {

  GENERATED_BODY()

public:
  AITwinCesiumCartographicPolygon();
