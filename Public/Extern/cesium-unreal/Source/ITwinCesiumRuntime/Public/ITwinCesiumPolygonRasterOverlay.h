...
#include "ITwinCesiumPolygonRasterOverlay.generated.h"
...
class ITWINCESIUMRUNTIME_API UITwinCesiumPolygonRasterOverlay
    : public UITwinCesiumRasterOverlay {
  GENERATED_BODY()

public:
  UITwinCesiumPolygonRasterOverlay();

  /**
   * The polygons to rasterize for this overlay.
   */
  UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cesium")
  TArray<AITwinCesiumCartographicPolygon*> Polygons;
